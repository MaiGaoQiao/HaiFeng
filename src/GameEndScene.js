...
var GameEndSceneLayer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        helloLabel.setColor(cc.color(0x00,0x00,0x00));
        ...
        this.scoreLabel.color = cc.color(0x00,0x00,0x00);
        // add the label as a child to this layer
        ...
        this.highScoreLabel.color = cc.color(0x00,0x00,0x00);
        // add the label as a child to this layer
...
var ShareUI = cc.LayerColor.extend({
    ctor: function () {
        this._super(cc.color(255, 255, 255, 255), cc.winSize.width, cc.winSize.height);
        var bg = new cc.Sprite(res.gamebg_png);//bg1_jpg
        ...
        this.addChild(bg);
        bg.setPosition(cc.winSize.width/2+40,cc.winSize.height/2+120);
    },
    onEnter: function () {
        this._super();
